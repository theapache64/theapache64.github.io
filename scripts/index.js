...
const end = moment("1997-01-07").tz('America/Los_Angeles'); // birth date
...
for (i = 0; i < starSpans.length; i++) {
    ...
    // Default value
    currentSpan.innerHTML = `Check it out <a href="https://github.com/theapache64/${repo}" target="_blank">on GitHub</a>`;

    fetch(`https://api.github.com/repos/theapache64/${repo}`, {
        mode: 'no-cors',
        cache: 'no-cache',
        ...
        .then(json => {
            ...
            currentSpan.innerHTML = `Currently has <strong>${starGazers}</strong> stars <a href="https://github.com/theapache64/${repo}" target="_blank">on GitHub</a>`;
        })
